#!/bin/bash
# CentOS OceanBase Automated Deployment Script
# This script deploys the complete CentOS 7.9 OceanBase cluster with a single command
...
echo "=========================================="
echo "  CentOS OceanBase Cluster Deployment"
echo "=========================================="
echo ""
