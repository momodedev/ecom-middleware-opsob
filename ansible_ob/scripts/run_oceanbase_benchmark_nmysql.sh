#!/bin/bash
###############################################################################
# run_oceanbase_benchmark_nmysql.sh
#
...
#
# Example:
#   ./run_oceanbase_benchmark_nmysql.sh d8s_v6_rocky 172.17.1.6 \
#       root@sbtest_tenant 'OceanBase#!123' sbtest "172.17.1.5 172.17.1.6 172.17.1.7"
###############################################################################
set -uo pipefail
