...
$localOut$localOut = 'C:/Users/v-chengzhiz/Downloads/ecom-middleware-opsob/benchmark_results/loop16_obproxy_centos_exp2'
...
for ($cycle=1; $cycle -le 16; $cycle++) {
  ...
  $cycleLabel = "d8s_v5_centos_nmysql_p_loop16_iter$cycle"
